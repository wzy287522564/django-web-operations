...
showWin: function(width, height, title, src) {
        ...
        inntHtml += '<div id="maskTop" class="panel panel-primary" style="width: ' + width + 'px; height: ' + height + 'px; border: #999999 1px solid; background: #fff; color: #333; position: fixed; top: 50%; left: 50%; margin-left: -' + marginLeft + 'px; margin-top: -' + marginTop + 'px; z-index: 2999; filter: progid:DXImageTransform.Microsoft.Shadow(color=#909090,direction=120,strength=4); -moz-box-shadow: 2px 2px 10px #909090; -webkit-box-shadow: 2px 2px 10px #909090; box-shadow: 2px 2px 10px #909090;">'
        inntHtml += '<div id="maskTitle" class="panel-heading" style="height: 50px;font-family: Microsoft Yahei;font-size: 20px;color: #333333;padding-left: 0px;background-image: url(data:image/png;base64,);border-bottom: 1px solid #999999;position: relative;width: 800px;padding-right: 0px;">'
        inntHtml += '' + title + ''
